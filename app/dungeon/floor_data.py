...
class FloorData:
    ...
    def __init__(self, dungeon_id: int, floor_id: int):
        ...
        (
            ...
            self.monster_house,
            self.sticky_item,
            self.empty_monster_house,
            self.hidden_stairs,
            self.secondary_used,
            self.secondary_percentage,
            self.imperfect_rooms,
            self.unkE,
            self.kecleon_shop_item_positions,
            self.hidden_stairs_type,
            self.enemy_iq,
            self.iq_booster_boost,
        ) = cursor.execute(
        ...
        self.trap_list, self.trap_weights = zip(
            *cursor.execute(
